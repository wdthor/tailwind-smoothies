  ...
  <div class="home flex flex-wrap mx-4">
    ...
    >
      ...
      @click="deleteSmoothie(smoothie.id)"
        ...
        class="h-8 w-8 absolute cursor-pointer right-0 mr-6 mt-2 fill-current text-red-500"
        viewBox="0 0 24 24"
      >
        <path
          class="heroicon-ui"
      ...
      <div class="card flex flex-col items-center bg-gray-400 py-10 px-4 rounded-lg shadow-xl mx-4">
...
export default {
  ...
  methods: {
    deleteSmoothie(smoothieId) {
      ...
      db.collection('smoothies').doc(smoothieId).delete() // delete smoothie in the backend
      .then(() => {
