<template>
  <nav class="relative flex items-center justify-between flex-wrap bg-blue-700 p-6 mb-10">
    <router-link :to="{ name : 'Home' }"  tag="a" class="flex items-center flex-shrink-0 text-white mr-6">
